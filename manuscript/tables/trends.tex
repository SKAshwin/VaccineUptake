\begin{minipage}{6.25in}
	...
	\hline\hline
	\end{tabular*}
    \caption*{\footnotesize{Notes: Standard errors, clustered by county, in brackets. Dependent variable was percentage of people with at least two doses of the COVID-19 vaccine. $\mathbf{rural}$ omitted as it was insignificant in Table \ref{eq:crosssection}, state fixed effects and non-interactions ommitted for brevity. 
