...
*** IE keep pairs if one county in CO and one in NE/KS, OR
*** one in NE/KS and one in KY
...
keep if (inlist(fips, 8009, 8099, 8061, 8017, 8063, 8125, 8095, 8115, 8075, 8123) & ///
 inlist(fipsadjacent, 20129, 20187, 20075, 20071, 20199, 20181, 20023, ///
 31057, 31029, 31135, 31101, 31049, 31033, 31105)) | ///
 (inlist(fips,  20129, 20187, 20075, 20071, 20199, 20181, 20023, ///
  31057, 31029, 31135, 31101, 31049, 31033, 31105) & ///
 inlist(fipsadjacent, 8009, 8099, 8061, 8017, 8063, 8125, 8095, 8115, 8075, 8123))
...
keep if inlist(fips, 8009, 8099, 8061, 8017, 8063, 8125, 8095, 8115, 8075, 8123) | inlist(fips, 20129, 20187, 20075, 20071, 20199, 20181, 20023) | inlist(fips, 31057, 31029, 31135, 31049, 31033, 31105)
...
drop if date <= td(25may2021)-14 | date >= td(25may2021)+14
